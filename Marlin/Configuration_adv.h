...
#define AUTOTEMP
  ...
  #define AUTOTEMP_PROPORTIONAL
    ...
    #define AUTOTEMP_MAX_P      30 // (°C) Added to the target temperature
...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (999)    // (seconds) Time without extruder movement to trigger protection
...
#define ASSISTED_TRAMMING
  ...
  //#define TRAMMING_POINT_XY { {  32, 87 }, { 338,  87}, { 338, 273 }, { 32, 273 } }
  #define TRAMMING_POINT_XY { {  37, 97 }, { 337,  97}, { 337, 283 }, { 37, 283 } }
...
//#define DISABLE_IDLE_Z2    // Disable if the nozzle could fall onto your printed part!
...
#define DEFAULT_MINIMUMFEEDRATE       5.0     // (mm/s. °/s for rotational-only moves) Minimum feedrate. Set with M205 S.
#define DEFAULT_MINTRAVELFEEDRATE     5.0     // (mm/s. °/s for rotational-only moves) Minimum travel feedrate. Set with M205 T.
 ...
 */
#define XY_FREQUENCY_LIMIT      30 // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define MANUAL_MOVE_DISTANCE_MM    200, 100, 50, 10, 1.0, 0.1  // (mm)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_CACHE_VFATS 10      // Maximum number of 13-byte VFAT entries to use for sorting.
 ...
 */
   ...
   */
  //#define DISPLAY_SLEEP_MINUTES CUSTOM  // (minutes) Timeout before turning off the screen. Set with M255 S.
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH                0.30   // (mm) Default retract length (positive value)
  #define RETRACT_LENGTH_SWAP          15   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             45   // (mm/s) Default feedrate for retracting
  #define RETRACT_ZRAISE                0.20   // (mm) Default retract Z-raise
  #define RETRACT_RECOVER_LENGTH        0   // (mm) Default additional recover length (added to retract length on recover)
  #define RETRACT_RECOVER_LENGTH_SWAP   15   // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
 ...
 */
  ...
  #define TOOLCHANGE_PARK
    ...
    #define TOOLCHANGE_PARK_XY    { X_MIN_POS + 10, Y_MIN_POS + 30 }
 ...
 */
   ...
   */
  //#define  X_SLAVE_ADDRESS 0  //Hammer
  //#define  Y_SLAVE_ADDRESS 0  //Hammer
  //#define  Z_SLAVE_ADDRESS 1  //Hammer
  //#define X2_SLAVE_ADDRESS 0
  //#define Y2_SLAVE_ADDRESS 0
  //#define Z2_SLAVE_ADDRESS 1  //Hammer
  ...
  //#define E0_SLAVE_ADDRESS 2  //Hammer
...
//#define I2C_POSITION_ENCODERS
   ...
   */
  #define I2CPE_MIN_UPD_TIME_MS     80                       // (ms) Minimum time between encoder checks.
