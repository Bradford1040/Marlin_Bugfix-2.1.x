...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_IDLE      180 // (0-255) Idle speed, used when motors are disabled
 ...
 */
#define DEFAULT_STEPPER_TIMEOUT_SEC 720
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_2_GCODE "M140 S" STRINGIFY(PREHEAT_4_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND)
