...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (16.64*60)    // (seconds) Time without extruder movement to trigger protection
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_RETRACT_LEN 0.5 // (mm) Length of filament to retract on fail. Requires backup power.
...
#define FWRETRACT
  ...
  #define RETRACT_RECOVER_LENGTH_SWAP   13   // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_4_DESC "Bed Visualize"
  #define MAIN_MENU_ITEM_4_GCODE "M118 A1 action:BEDLEVELVISUALIZER_LEVELBED"
