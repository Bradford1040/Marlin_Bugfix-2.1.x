 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1600, 873.68 }
...
#define DEFAULT_EJERK    0.50  // May be used by Linear Advance
 ...
 */
#define Z_MIN_PROBE_PIN PC0 //using Z stop pin, PC13 is BL touch Probe socket pin
 ...
 */
//#define FIX_MOUNTED_PROBE /Enable this for MicroProbeV2
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2, -57, 0 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 6), (Y_MIN_POS + 55), 20 }
