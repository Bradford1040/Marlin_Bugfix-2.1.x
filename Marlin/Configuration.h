...
#define CUSTOM_MACHINE_NAME "PUNISHER!"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "6db1c193-dd5a-4e84-9d89-88cea6471af8"
 ...
 *    61 : 100kΩ Formbot/Vivedino 350°C Thermistor - beta 3950 (Ender 5 Plus Thermistor ordered from Amazon, Hammer)
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 16.94f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.0506f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1771f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.2672f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  //#define FILAMENT_HEAT_CAPACITY_PERMM { 5.22e-3f } // 0.00522 J/K/mm for 1.75mm Nylon (0.0138 J/K/mm for 2.85mm Nylon).

  // Advanced options
  #define MPC_SMOOTHING_FACTOR 0.25f                   // (0.0...1.0) Noisy temperature sensors may need a lower value for stabilization, A lower value than 1 will result in greater stability in MPC output power but also in decreased responsiveness. A value around 0.25 seems to work quite well
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 15.7536
  #define DEFAULT_bedKi 0.22530
  #define DEFAULT_bedKd 734.329
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH //switch to LOW for microprobe_v2
 ...
 * :[2,3,4,5,6,7]
 */
//#define ENDSTOP_NOISE_THRESHOLD 2 // will not work with sensorless homing
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 3200, 436.84 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5500, 5500, 300, 6000 }
...
#define DEFAULT_EJERK    0.500  // May be used by Linear Advance
...
//#define EVENT_GCODE_AFTER_HOMING "M300 P440 S200"  // Default M300 P440 S200 are tones to play, Commands to run after G28 (and move to XY_AFTER_HOMING)
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  #define MIN_SOFTWARE_ENDSTOP_Z2
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define MAX_SOFTWARE_ENDSTOP_Z2
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 Z7 F8400\n G1 X15 Y55\n G1 Z0.5\n G1 Z7"
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 12, 67, 12, 57 } // (mm) Left, Front, Right, Back insets
...
#define HOMING_FEEDRATE_MM_M { 4500, 4500, 480 }  //Hammer Speed
...
#define PREHEAT_3_LABEL       "PLA_PRO"
#define PREHEAT_3_TEMP_HOTEND 225
#define PREHEAT_3_TEMP_BED     70
//#define PREHEAT_3_TEMP_CHAMBER 35
#define PREHEAT_3_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_4_LABEL       "PLA_PLUS"
...
#define PREHEAT_6_TEMP_BED    62
//#define PREHEAT_6_TEMP_CHAMBER 35
#define PREHEAT_6_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_7_LABEL       "ABS"
#define PREHEAT_7_TEMP_HOTEND 265
...
#define PREHEAT_8_TEMP_HOTEND 255
#define PREHEAT_8_TEMP_BED     68
