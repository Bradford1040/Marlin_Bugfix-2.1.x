 ...
 */
  ...
  // Advanced options
  #define MPC_SMOOTHING_FACTOR 0.25f                   // (0.0...1.0) Noisy temperature sensors may need a lower value for stabilization.
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH  // Enable pull ups for MicroProbe V2
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 700, 700, 15, 200 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2, -57, -2.6289 }
...
#define XY_AFTER_HOMING { 6, 55 }  // (mm) Move to an XY position after homing (and raising Z)
