...
#define CUSTOM_MACHINE_NAME "ABLE!"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "5cb1998d-827b-43b9-baa3-69f3946a0ca5"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 17.28f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.5404f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1043f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1475f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 166.0471
  #define DEFAULT_bedKi 30.081
  #define DEFAULT_bedKd 611.0533
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1600, 851.54 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 18, 60 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 700, 700, 100, 1500 }
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 19.0
  #define DEFAULT_YJERK 19.0
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40.00, -5.00, -2.4741 }
